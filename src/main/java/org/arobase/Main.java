...
import org.arobase.client.LancerProxy;
...
public class Main {
    public static void main(String[] args) {
        ...
        if (args.length < 1) {
            System.err.println("Veuillez choisir un service ('proxy', 'serveur', 'service-bd', 'service-enssup')");
            System.exit(1);
        }

        switch (args[0]) {
            case "proxy" -> serviceChoisi = new LancerProxy();
